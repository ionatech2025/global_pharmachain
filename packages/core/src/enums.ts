...
export const COMPANY_TYPES = [
  ...
  "LABORATORY_CONSUMABLES_SUPPLIER",
...
export const COMPANY_TYPE_LABELS: Record<CompanyType, string> = {
  ...
  LABORATORY_CONSUMABLES_SUPPLIER: "Laboratory Consumables Suppliers",
  ENGINEERING_SERVICES: "Engineering Services",
  PROJECT_CONSULTANT: "Project Consultants",
  PACKAGING_MATERIALS_SUPPLIER: "Packaging Materials Suppliers",
  ARTWORK_DESIGNER: "Artwork Designers",
  MEDICAL_CENTER: "Medical Center",
  WHOLESALE_PHARMACY: "Wholesale Pharmacy",
  FINISHED_PRODUCT_DISTRIBUTOR: "Finished Product Distributor",
